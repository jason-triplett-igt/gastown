...
func toolCallbacksFor(townRoot, workDir string) toolapi.Callbacks {
	return toolapi.Callbacks{
		...
		ResolveSessionName: resolveTargetSessionName,
...
func resolveTargetSessionName(target string) (string, error) {
